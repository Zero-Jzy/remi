    ...
    <div style="width: 550px; margin: 30px auto; padding: 30px" class="shadow-sm">
        <form action="/create_movie" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="key_movie" id="url_video" class="form-control" placeholder="Url movie">
            </div>
            <div class="form-group">
                <label for="description">Title</label>
                <textarea type="text" name="description" id="description" class="form-control" rows="3" placeholder="Title"></textarea>
            </div>
